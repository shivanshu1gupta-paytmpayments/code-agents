...
echo -e "    ${DIM}  1. Ask for API keys (Cursor/Claude)${RESET}"
echo -e "    ${DIM}  2. Ask for Jenkins/ArgoCD config (optional)${RESET}"
echo -e "    ${DIM}  3. Write .env in your project directory${RESET}"
echo -e "    ${DIM}  4. Start the server pointing at your repo${RESET}"
echo ""
