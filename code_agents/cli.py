...
def cmd_help():
    ...
    p(f"      Supports multi-turn sessions, streaming, and /agent switching.")
    p(f"        {dim('<agent-name>')}  Skip menu, start with specific agent")
    ...
    p(f"      Chat commands: /help /quit /agent <name> /agents /session /clear")
    p()
    p(f"    {cyan('setup')}")
